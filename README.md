...
- **[Harvey Tools](https://github.com/meltingpixelsai/harvey-tools)** - Web scraping, screenshots, code review, content generation, and sentiment analysis for AI agents. Pay-per-call USDC via x402 micropayments.
